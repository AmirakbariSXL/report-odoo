...
#            debit_account = Parameters.get_param('gt_cheque_management.debit_out_account')
        ...
        res.update({'debit_account':int(debit_account) or False,
                    'credit_account':int(credit_account) or False,
                    'bank_account':int(Parameters.get_param('gt_cheque_management.deposite_account')) or False,
                    'journal_id':int(Parameters.get_param('gt_cheque_management.journal_id')) or False})
        return res
